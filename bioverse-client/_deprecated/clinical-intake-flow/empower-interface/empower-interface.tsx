...
//     const [providerData, setProviderData] = useState<EmpowerPrescriber>();
...
//             lfPracticeId: parseInt(process.env.EMPOWER_PRACTICE_ID!), //set by Empower.
//             newRxs: newRxArray,
//         });
...
//         const selectedClinicianId = event.target.value;
//         setSelectedClinician(selectedClinicianId);

//         const addressForProvider: EmpowerAddress = {
//             addressLine1: providerAddress.address_line1,
//             city: providerAddress.city,
//             stateProvince: providerAddress.state,
//             postalCode: providerAddress.zip,
//             countryCode: 'US',
//         };

//         let selectedClinicianObject =
//             providerListByUUID[
//                 event.target.value as keyof typeof providerListByUUID
//             ];

//         setProviderData({
//             npi: selectedClinicianObject.npi,
//             stateLicenseNumber: selectedClinicianObject.state_license_number,
//             lastName: selectedClinicianObject.last_name,
//             firstName: selectedClinicianObject.first_name,
//             address: addressForProvider,
//             phoneNumber: selectedClinicianObject.phone_number,
//         });
//     };
...
//             medication: newMedication, // Use medication instead of diagnosis
//         };
...
//             itemDesignatorId: 'C0F34D98BC3218F057D4572CF106E66A', // Adjust the type according to what itemDesignatorId can contain
//             drugDescription:
...
//                                     Please Select
//                                 </MenuItem>
//                                 <MenuItem value='24138d35-e26f-4113-bcd9-7f275c4f9a47'>
//                                     Maylin Chen
//                                 </MenuItem>
//                                 <MenuItem value='da5b213d-7676-4792-bc73-11151d0da4e6'>
//                                     Amanda Little
//                                 </MenuItem>
//                                 <MenuItem value='025668ab-3f9e-4839-a0c5-75790305cfe9'>
//                                     Dr. German Echeverry
//                                 </MenuItem>
//                             </Select>
//                         </FormControl>
...
//                                                         value={item.id}
//                                                     >
//                                                         {`${item.drugDescription} , ${item.dosage} , ${item.quantity} , ${item.form}`}
//                                                     </MenuItem>
//                                                 ))}
//                                             </Select>
