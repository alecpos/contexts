...
// import { findMedicationById } from './utils/tmc-medication-ids';
...
//                     Quantity:
//                         orderData.subscription_type === 'monthly' ? '1' : '3',
//                     NoOfOriginalRefills: '0',
//                     NoOfRefillRemaining: '0',
...
//         await saveScriptForFutureUse(prescriptionForm, orderData.id, 'tmc');
