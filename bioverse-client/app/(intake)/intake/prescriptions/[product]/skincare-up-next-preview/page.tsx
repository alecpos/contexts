...
import SkincareUpNextPreviewComponent from '@/app/components/intake-v2/pages/skincare-up-next-preview';
...
export default async function SkincareUpNextPreviewPage({
    params,
    searchParams,
}: Props) {
    ...
    return (
        <>
            <SkincareUpNextPreviewComponent />
        </>
    );
}
