...
import WLAccomplishGoalsComponent from '@/app/components/intake-v2/pages/wl-accomplish-goals';
...
export default async function WLAccomplishGoals({
    params,
    searchParams,
}: Props) {
