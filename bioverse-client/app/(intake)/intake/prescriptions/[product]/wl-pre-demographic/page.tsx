...
import WLPreDemographicComponent from '@/app/components/intake-v2/pages/wl-pre-demographic';
...
export default async function WLPreDemographicsPage({
    params,
    searchParams,
}: Props) {
