...
import WLInfographicHersComponent from '@/app/components/intake-v3/pages/wl-infographic-hers-v3';
...
export default async function WLInfographicHersPage({
    params,
    searchParams,
}: Props) {
    //Immediately check user session presenc

    return <WLInfographicHersComponent />;
}
