...
import WLIntroQuestion4Component from '@/app/components/intake-v3/pages/wl-intro-question-4-v3';
...
export default async function WLIntroQuestion4Page({
    params,
    searchParams,
}: Props) {
