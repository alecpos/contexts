...
import WLIntroQuestion2Component from '@/app/components/intake-v3/pages/wl-intro-question-2-v3';
...
export default async function WLIntroQuestion2Page({
    params,
    searchParams,
}: Props) {
