...
import WLAnimatedIntroClient from '@/app/components/intake-v2/pages/wl-animated-intro';
...
export default async function AnimatedIntroPage({}: Props) {
    return (
        <>
            <WLAnimatedIntroClient />
        </>
    );
}
