...
import UpNextPreviewComponent from '@/app/components/intake-v2/pages/up-next-preview';
import WLUpNextPreviewComponent from '@/app/components/intake-v2/pages/wl-up-next-preview';
...
export default async function UpNextHealthPage({
    params,
    searchParams,
}: Props) {
