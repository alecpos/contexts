...
import WLGraphContainerPreSignup from '@/app/components/intake-v3/pages/wl-graph-presignup';
import WLIntroFirstClientComponentNew from '@/app/components/intake-v3/pages/wl-intro-1';
...
export default async function WLGraphPreSignup({
    params,
    searchParams,
}: Props) {
    ...
    return (
        <>
            <WLGraphContainerPreSignup product_href={params.product} />
        </>
    );
}
