...
import TreatmentSafetyComponent from '@/app/components/intake-v3/pages/treatment-safety';
...
export default async function TreatmentSafetyPage({
    params,
    searchParams,
}: Props) {
    return (
        <>
            <TreatmentSafetyComponent />
        </>
    );
}
