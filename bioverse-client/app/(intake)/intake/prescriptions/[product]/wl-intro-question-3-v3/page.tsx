...
import WLIntroQuestion3Component from '@/app/components/intake-v3/pages/wl-intro-question-3-v3';
...
export default async function WLIntroQuestion3Page({
    params,
    searchParams,
}: Props) {
    ...
    return (
        <>
            <WLIntroQuestion3Component user_id={user_id} />
        </>
    );
}
