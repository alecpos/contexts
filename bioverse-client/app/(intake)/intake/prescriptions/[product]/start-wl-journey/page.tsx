...
import StartWLJourneyComponent from '@/app/components/intake-v2/pages/start-wl-journey';
...
export default async function StartWLJourneyPage({
    params,
    searchParams,
}: Props) {
