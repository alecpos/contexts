...
export default async function WLIntroPageFirst({
    params,
    searchParams,
}: Props) {
    ...
    if (params.product === 'semaglutide' || params.product === 'tirzepatide') {
        return <WLIntroFirstClientComponentNew />;
    }

    return (
        <>
            <WLIntroFirstClientComponent />
        </>
    );
}
