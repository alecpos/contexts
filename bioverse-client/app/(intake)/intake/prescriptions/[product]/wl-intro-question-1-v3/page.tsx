...
import WLIntroQuestion1Component from '@/app/components/intake-v3/pages/wl-intro-question-1-v3';
...
export default async function WLIntroQuestionPage({
    params,
    searchParams,
}: Props) {
