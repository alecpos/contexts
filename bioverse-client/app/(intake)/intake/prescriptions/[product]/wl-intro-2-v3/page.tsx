...
import WLIntroSecondClientComponentNew from '@/app/components/intake-v3/pages/wl-intro-2';
...
export default async function WLIntroPageSecondNew({}: Props) {
    return (
        <>
            <WLIntroSecondClientComponentNew />
        </>
    );
}
