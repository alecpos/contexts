...
import WLIntroGraphClientComponent from '@/app/components/intake-v3/pages/wl-intro-graph-v3';
...
export default async function WLIntroGraphPage({
    params,
    searchParams,
}: Props) {
