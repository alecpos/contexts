...
import PatientMatchOneMoment from '@/app/components/intake-v2/pages/patient-match-one-moment';
...
export default async function PatientMatchPage({
    params,
    searchParams,
}: Props) {
