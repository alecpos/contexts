...
import DemographicCollectionScreen from '@/app/components/intake-v2/pages/demographic-collection';
...
interface Props {
    ...
    searchParams: {
        ...
        ub: any; // if coming froma unbounce, this will be set to the landing page they're coming from
        /**
...
export default async function DemographicCollectionPage({
    params,
    searchParams,
}: Props) {
