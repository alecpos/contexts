...
import PreDemographicComponent from '@/app/components/intake-v2/pages/pre-demographic';
...
export default async function PreDemographicsPage({
    params,
    searchParams,
}: Props) {
