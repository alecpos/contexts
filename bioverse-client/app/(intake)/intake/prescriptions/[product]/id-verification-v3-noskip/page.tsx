...
import IDVerificationV3NoSkip from '@/app/components/intake-v3/pages/id-verification-noskip-v3';
...
export default async function IntakeLicenseSelfieNoSkipPage() {
