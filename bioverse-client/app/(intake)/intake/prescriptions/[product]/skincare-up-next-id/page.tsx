...
import SkincareUpNextIdComponent from '@/app/components/intake-v2/pages/skincare-up-next-id';
...
export default async function SkincareUpNextIDPage({
    params,
    searchParams,
}: Props) {
