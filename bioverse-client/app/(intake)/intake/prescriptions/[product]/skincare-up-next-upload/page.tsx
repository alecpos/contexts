...
import SkincareUpNextUploadComponent from '@/app/components/intake-v2/pages/skincare-up-next-upload';
...
export default async function SkincareUpNextUploadPage({
    params,
    searchParams,
}: Props) {
