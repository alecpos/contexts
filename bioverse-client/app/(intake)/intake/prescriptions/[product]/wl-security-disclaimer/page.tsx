...
import TreatmentEvolveComponent from '@/app/components/intake-v3/pages/treatment-evolve';
import TreatmentSupportComponent from '@/app/components/intake-v3/pages/treatment-support';
import WLSecurityDisclaimerComponent from '@/app/components/intake-v2/pages/wl-security-disclaimer';
...
export default async function WLSecurityDisclaimerPage({
    params,
    searchParams,
}: Props) {
    return (
        <>
            <WLSecurityDisclaimerComponent />
        </>
    );
}
