...
import ReasonsToBelieveComponent from '@/app/components/intake-v2/pages/rtb';
import ReasonsToBelieveComponentV3 from '@/app/components/intake-v3/pages/rtb-v3';
...
export default async function RTBPage({ params, searchParams }: Props) {
    //Immediately check user session presence
    const user_id = (await readUserSession()).data.session?.user.id!;

    return (
        <>
            <ReasonsToBelieveComponentV3 />
        </>
    );
}
