...
import WLIntroSpecialistsClientComponentV3 from '@/app/components/intake-v3/pages/wl-intro-specialists-v3';
...
export default async function WLIntroSpecialistsPageV3({
    params,
    searchParams,
}: Props) {
    ...
    return (
        <>
            <WLIntroSpecialistsClientComponentV3 />
        </>
    );
}
