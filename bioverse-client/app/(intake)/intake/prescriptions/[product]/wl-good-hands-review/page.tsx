...
import WLGoodHandsReview from '@/app/components/intake-v3/pages/wl-good-hands-review';
...
export default async function WLGoodHandsPage({ params, searchParams }: Props) {
    return (
        <>
            <WLGoodHandsReview />
        </>
