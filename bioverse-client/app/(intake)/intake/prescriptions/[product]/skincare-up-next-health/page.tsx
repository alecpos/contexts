...
import SkincareUpNextHealthComponent from '@/app/components/intake-v2/pages/skincare-up-next-health';
...
export default async function SkincareUpNextHealthPage({
    params,
    searchParams,
}: Props) {
