...
import CheckoutContainer from '@/app/components/intake-v3/pages/new-checkout';
...
export default async function IntakeCheckoutPage({
    ...
    const product_data = {
        ...
        variant: searchParams.pvn === 'undefined' ? 0 : parseInt(searchParams.pvn) || 0,
        subscriptionType: searchParams.st === 'undefined' ? 'one_time' : searchParams.st || 'one_time',
    ...
    console.log('DEBUG - Product Data:', {
        ...
        searchParams,
        params,
        parsedVariant: searchParams.pvn === 'undefined' ? 0 : parseInt(searchParams.pvn) || 0
    });
