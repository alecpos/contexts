...
import { getProviderArray } from '@/app/utils/functions/provider-portal/time-tracker/provider-time-tracker-functions';
...
export default async function TrackHoursPage({}: PageProps) {
    ...
    const providerArray = await getProviderArray();
