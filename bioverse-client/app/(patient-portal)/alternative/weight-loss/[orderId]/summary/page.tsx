...
import AltSelectionSummaryComponent from '@/app/components/patient-portal/alternative-selection/weight-loss/selection-summary/alt-selection-summary';
...
export default async function SelectAlternativeCadencePage({
    ...
    return (
        <>
            <div className='w-full bg-[#F7F8F8] flex justify-center min-h-screen'>
                <AltSelectionSummaryComponent order_data={data.order_data} />
            </div>
        </>
    );
}
