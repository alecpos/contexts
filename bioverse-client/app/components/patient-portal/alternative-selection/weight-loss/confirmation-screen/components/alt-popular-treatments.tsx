...
import PopularTreatmentItem from '@/app/components/patient-portal/subscriptions/components/SubscriptionList/components/PopularTreatmentItem';

export default function AltPopularTreatments({ filtered }: Props) {
