...
export default function AppleOAuthButtonV2({
    currentUrl,
    className,
    labelClassName,
}: Props) {
    ...
    return (
        <>
            ...
            >
                <BioType
                    className={`inter-body text-[#000000] text-[18px] font-bold normal-case border-[#D8D8D8] tracking-normal ${labelClassName}`}
                >
                    Continue with Apple
                </BioType>
            </Button>
