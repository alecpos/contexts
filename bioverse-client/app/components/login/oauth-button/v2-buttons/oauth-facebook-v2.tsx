...
import { facebookOAuthSignIn } from '@/app/utils/actions/auth/oauth';
...
export default function FacebookOAuthButtonV2({
    currentUrl,
    className,
    labelClassName,
}: Props) {
    ...
    return (
        <>
            ...
            >
                <BioType
                    className={`inter-body text-[#000000] text-[18px] font-bol normal-case border-[#D8D8D8] tracking-normal ${labelClassName}`}
                >
