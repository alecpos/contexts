...
interface AnythingElseComponentCustomQuestionProps {
...
export default function AnythingElseComponentCustomQuestion({
    formInformation,
    setFormInformation,
    setResponse,
    setAnswered,
    ...
    handleQuestionContinue,
    answered,
}: AnythingElseComponentCustomQuestionProps) {
        ...
        <div className="flex flex-col items-center h-full w-full gap-[2.5vw]">
            <div className="flex flex-col gap-[16px] rounded-md border">
                <BioType className={`${QUESTION_HEADER_TAILWIND}`}>
                    Tell us anything else you&apos;d like your provider to know
                    when refilling your medication.
                </BioType>
