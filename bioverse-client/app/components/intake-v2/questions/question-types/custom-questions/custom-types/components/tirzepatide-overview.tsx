                    ...
                    <div className="flex flex-col md:gap-[28px] gap-4 animate-slideRight">
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex flex-col md:gap-2 gap-4">
                                ...
                                >
                                    Tirzepatide is the generic name for
                                    Mounjaro® and Zepbound™, GLP-1 medications
                                    that are FDA-approved for treatment of type
                                    2 diabetes and weight loss respectively.{' '}
                                    <br />
                                    <br />
                                    Compounded tirzepatide contains the same
                                    active ingredient as the commercially
                                    available medications Mounjaro® and
                                    Zepbound™.*
                                </BioType>
                            </div>
                            <Divider />
                            <div className="flex flex-col md:gap-2 gap-4">
                                ...
                                >
                                    ...
                                    tirzepatide injections led to 20% of body
                                    weight loss on average over 72 weeks.†
                                </BioType>
                            </div>
                            <Divider />
                            <div className="flex flex-col md:gap-2 gap-4">
                                ...
                                <BioType
                                    className={`${INTAKE_PAGE_BODY_TAILWIND} text-textSecondary`}
                                >
                                    BIOVERSE offers compounded tirzepatide for
                                    as low as $
                                    {getPrice(PRODUCT_HREF.TIRZEPATIDE)}/month –
