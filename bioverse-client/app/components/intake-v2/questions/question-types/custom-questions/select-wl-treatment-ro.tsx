...
import MetforminOverviewComponent from './custom-types/components/metformin-overview';
import SemaglutideOverviewComponent from './custom-types/components/semaglutide-overview';
import TirzepatideOverviewComponent from './custom-types/components/tirzepatide-overview';
import WLSelectionOptions from './custom-types/components/wl-selection-options';

interface SelectWLTreatmentProps {
    handleContinueButton: any;
}

export default function SelectWLTreatmentRoComponent({
