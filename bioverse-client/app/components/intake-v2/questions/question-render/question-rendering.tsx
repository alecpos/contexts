...
const DynamicCheckboxQuestion = dynamic(
    () => import('../question-types/checkbox'),
    {
...
const DynamicCustomQuestion = dynamic(
    () => import('../question-types/custom-questions/custom'),
    {
        loading: () => <LoadingScreen />,
        ssr: false,
    }
);
const DynamicInputQuestion = dynamic(() => import('../question-types/input'), {
    loading: () => <LoadingScreen />,
    ssr: false,
});
const DynamicLogicQuestion = dynamic(() => import('../question-types/logic'), {
    loading: () => <LoadingScreen />,
    ssr: false,
});
...
const DynamicRadioQuesiton = dynamic(() => import('../question-types/radio'), {
    loading: () => <LoadingScreen />,
    ssr: false,
});
...
export default function QuestionRenderComponent({
    question,
    answer,
    questionId,
    user_id,
    ...
    const handleInputResponseChange = useCallback(
        (index: number, value: string) => {
            setFormInformation((prevFormInformation) => {
                ...
                console.log(updatedFormInformation);
