...
export default function WeightLossGraph({
    ...
    const renderLineChart = (
        <>
            <div className="body1 md:flex md:w-full md:h-full relative">
                {/* <div
                ...
                <div
                    className="h-1 w-1 absolute bg-white border-1 border-solid rounded-full z-50 transition-all ease-linear duration-200"
                    style={pointStyle}
                    ref={handlePointRef}
                ></div>
