...
export default function PreIdBScreen({
    user_id,
    preExistingLicense,
    preExistingSelfie,
}: PreIDProps) {
                ...
                <div className='flex flex-col gap-4'>
                    <div className='gap-6 md:gap-4 flex-col flex'>
                        ...
                        <div className='flex flex-col gap-4 px-4'>
                            ...
                            <div className='ml-3 hidden md:flex mt-[124px] absolute'>
                                <VerticalGradientLineSVG
                                    height='25 '
                                    key={'linedesktopvert'}
                                    custom_gradient_stop='15'
                                />
                            </div>
                            <div className='ml-3 flex md:hidden mt-[30.5vw] absolute'>
