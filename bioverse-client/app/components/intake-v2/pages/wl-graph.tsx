...
import WeightLossGraph from '../wl-graph/wl-graph-component';
import WLPaper from '../wl-graph/wl-graph-info-paper';
import {
...
export default function WLGraphContainer({
    ...
    return (
        <div className={`justify-center items-start flex animate-slideRight`}>
                    ...
                    {getCompoundType(product_href) === 1 ? (
                        <div>
                            <BioType className="body1 !text-[16px] text-[#00000099]">
                                ...
                                double-blind trial which showed that individuals
                                using semaglutide lost up to 16.9% of their body
                                weight over a 68 week period. Treatment was
                                given in addition to diet and exercise.
                            </BioType>

                            <BioType className="body1 !text-[16px] text-[#00000099]">
                                Source: Once-Weekly Semaglutide in Adults with
                                Overweight or Obesity. John P.H. Wilding, D.M.,
                                Rachel L. Batterham, M.B., B.S., Ph.D. et al.
                            </BioType>
                        </div>
                    ) : (
                        <div>
                            <BioType className="body1 !text-[16px] text-[#00000099]">
                                ...
                                SURMOUNT-4 clinical trial results which showed
                                20% average weight loss over 36 weeks among
                                people utilized a maximum tolerated dose of 10
                                mg or 15 mg once-weekly. The starting dose of
                                2.5 mg tirzepatide was increased by 2.5 mg every
                                four weeks until the maximum tolerated dose was
                                achieved. Treatment was given in addition to
                                diet and exercise.
                            </BioType>
                        </div>
                    )}
