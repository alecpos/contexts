...
import DataCollectionInputV2 from '../account/data-collection/data-collection';
import {
    useParams,
    usePathname,
    useRouter,
...
export default function IntakeAccountScreen({
    ...
    const [currentStateOfResidence, setCurrentStateOfResidence] =
        useState<string>('');
