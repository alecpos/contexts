...
export default function PatientMatch({}: PatientMatchProps) {
    ...
    return (
        <div className="flex h-[60vh] justify-self-center w-full justify-center">
            <div className="flex flex-row gap-10">
                <div className="flex flex-col gap-8 md:h-full justify-center">
                    <div className="h5 !text-primary self-start">
                        <span
                            className=""
