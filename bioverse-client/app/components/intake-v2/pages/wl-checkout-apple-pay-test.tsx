...
import CheckoutV2 from '../checkout/checkout-component';
...
import WLCheckoutV2TestApplePay from '../checkout/components/wl-checkout-component-fulltest';
...
export default function WLCheckoutContainerApplePayTest({
    order_data,
    user_id,
    user_email,
    product_data,
