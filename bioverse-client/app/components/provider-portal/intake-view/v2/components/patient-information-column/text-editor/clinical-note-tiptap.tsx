...
import TipTapURLInputModal from './tiptap-url-input-modal';
...
const ClinicalNoteInputTiptap = ({ content, onContentChange }: TipTapProps) => {
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: 'border border-gray-300 border-solid rounded-md py-2 px-6',
            },
        },
    });
...
export default ClinicalNoteInputTiptap;
