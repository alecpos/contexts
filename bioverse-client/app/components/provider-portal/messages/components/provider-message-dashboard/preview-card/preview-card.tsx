...
import { ProviderThreadData } from '@/app/types/messages/messages-types';
import CircleIcon from '@mui/icons-material/Circle';
import MessageBubbleProviderPreview from './components/preview-card-content-provider';

interface MessagePreviewProps {
    thread_data: ProviderThreadData;
}
