...
export default function IDVerificationV3NoSkip({
    user_id,
    userGender,
    patientName,
    preExistingLicense,
    ...
    const pushToNextRoute = async () => {
        ...
        //test these:
        if (
            vwo_test_ids.includes(AB_TESTS_IDS.WL_SHOW_ID_AFTER_CHECKOUT) ||
            vwo_test_ids.includes(
                AB_TESTS_IDS.WL_GLOBAL_SHOW_ID_AFTER_CHECKOUT
            ) ||
            ...
            const replacedPath = fullPath.replace(
                'id-verification-v3-noskip',
                'id-verification-v3'
            );
