...
export default function WLIntroQuestion1Component({}: GoodToGoProps) {
    ...
    const [answer, setAnswer] = useSessionStorage('wl-intro-q1', {
        question:
                    ...
                    <div className="flex flex-col gap-8">
                        <div className="flex flex-col items-center justify-center gap-[2.5vw] p-0 min-w-full">
                            <div className="flex flex-col  rounded-md border min-w-full">
                                ...
                                >
                                    How would you describe the level of stress
