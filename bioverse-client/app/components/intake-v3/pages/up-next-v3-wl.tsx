...
import VerticalGradientLineSVGMobileV4 from '../../intake-v2/assets/vertical-gradient-line-mobile-v4';
                ...
                <div className='flex flex-row'>
                    <div className='flex flex-col'>
                        <div className='flex flex-col gap-[12px]'>
                            ...
                            >
                                Nice! Looks like you&apos;re good to go on our
                                end.
                            </BioType>

                            <BioType className={`intake-subtitle text-weak `}>
                                Next, answer some questions about you and your
                                lifestyle to complete your weight loss profile.
                                It takes less than 3 minutes.
                            </BioType>
                        </div>

                        <div className='block md:hidden'>
                            <div className='h-[20rem] relative mt-[1.25rem]'>
                                <Image
                                    src={'/img/intake/wl/mobileUpNext.png'}
                                    alt={'Up Next Image'}
                                    fill
                                    className='w-full'
                                    style={{
                        ...
                        <div className='hidden md:block'>
                            <div className='flex flex-row my-[48px] '>
                                <div className='flex flex-col justify-between gap-[1rem] mt-[0.6rem] md:mt-0'>
                                    <div className='mt-[1rem] md:mt-[7px]'>
                                        <svg
                                    ...
                                    <div className='mt-[3rem] md:mt-[67px] absolute'>
                                        <svg
                                            xmlns='http://www.w3.org/2000/svg'
                                            width='25'
                                            height='25'
                                    ...
                                    <div className='ml-[10px] hidden md:flex mt-[2rem] md:mt-[89px] absolute'>
                                        <VerticalGradientLineSVGV3
                                            height='182'
                                            key={'linedesktopvert'}
                                        />
                                    </div>
                                    <div className='flex md:hidden mt-[2.2rem] ml-[10px] absolute'>
                                        <VerticalGradientLineSVGMobileV4
                                            height='70vw'
                                            key={'linemobilevert'}
                                        />
                                    </div>

                                    <div className='ml-[1.5px] md:ml-0.5 mt-[16.2rem] md:mt-[223px] absolute'>
                                        <svg
                                            xmlns='http://www.w3.org/2000/svg'
                                            width='25'
                                            height='25'
                                    ...
                                    <div className='ml-[1.5px] md:ml-0.5 mt-[19.2rem] md:mt-[290px] absolute'>
                                        <svg
                                            xmlns='http://www.w3.org/2000/svg'
                                            width='25'
                                            height='25'
                                ...
                                <div className='flex flex-col ml-2 gap-[1.25rem] md:gap-[30px] justify-between'>
                                    <div className='mt-2'>
                                        <BioType
                                    ...
                                    <div className=' flex flex-col gap-1'>
                                        ...
                                        <div className='flex flex-row mt-2 w-[3/4] md:w-[435px]  h-[9.5rem] md:h-[94px] md:h-[94px] px-[1.501rem] md:px-[24px] items-center gap-[1.38rem] md:gap-[16px] rounded-md border border-opacity-20 border-[#666666] bg-white shadow-[27px_25px_10px_0px_rgba(0,0,0,0),17px_16px_9px_0px_rgba(0,0,0,0.01),10px_9px_8px_0px_rgba(0,0,0,0.05),4px_4px_6px_0px_rgba(0,0,0,0.09),1px_1px_3px_0px_rgba(0,0,0,0.1)]'>
                                            ...
                                            <div className='flex flex-1 w-[6.38rem] md:w-[435px]'>
                                                ...
                                                >
                                                    Tell us about your
                                                    experience with your weight
                                                    loss journey. Your answers
                                                    will help us better plan
                                                    your treatment.
                                                </BioType>
                                            </div>
                                        </div>
                                    ...
                                    <BioType
                                        className={` flex flex-row justify-start items-center intake-subtitle text-weak`}
                                    >
                                        Health History
                                    </BioType>
                                    <BioType
