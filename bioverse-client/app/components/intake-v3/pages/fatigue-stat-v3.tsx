...
const FatigueStatComponent = () => {
    ...
    return (
        <>
            <div className={`justify-center flex animate-slideRight mx-auto mt-[1.25rem] md:mt-[48px]`}>
                <div className="flex flex-col gap-8">
                    <div className="md:h-auto h-full flex flex-col gap-6 ">
                    <p className={`inter_h5_regular`}>
                    42% of Americans report feeling fatigued as early as 12 pm.
                        </p>
                        <p className={`inter_h5_bold`} style={{
