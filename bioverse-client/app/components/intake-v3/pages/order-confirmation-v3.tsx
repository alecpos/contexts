...
import NextStepsCardV3 from '../order-confirmation-new/components/NextStepsCard-v3';
import Link from 'next/link';
import PopularTreatments from '../order-confirmation-new/popular-treatments/PopularTreatments';
...
export const OrderConfirmationV3 = () => {
    ...
    return (
        <div className='w-full bg-[#fafafa] flex justify-center overflow-x-hidden pb-24 '>
            <div className='w-[90%] flex flex-col items-center'>
                <div className='md:w-[460px] flex flex-col mt-8 md:mt-12 items-center'>
                    ...
                    <div className='w-full mt-[3.94rem] md:mt-[63px]'>
                        <BioType className='inter-h5-question-header'>
                            Your virtual consultation is now complete!
                        </BioType>

                     
                        <BioType className='intake-v3-form-label-bold  mt-5   text-black'>
                            What is next?
                        </BioType>
                    </div>
                    <div className='w-full flex flex-col space-y-[20px] mt-8 intake-v3-18px-20px '>
                        <NextStepsCardV3
                            title='Your provider reviews your request.'
                            duration='Avg. 1-2 business days'
                            description='If the medication is the right fit, it will be prescribed. Your provider may reach out via our secure chat if they have any additional questions for you. '
                            borderColor='#11487F'
                        />
                        <NextStepsCardV3
                            title='After provider approval, we will ship your medication.'
                            duration='Avg. 10 business days'
                            description='If approved, your treatment will be charged to the card you provided and  shipped to you discreetly.'
                            borderColor='#2E7599'
                        />
                    </div>
                    <BioType className='self-start  text-black inter-h5-question-header mt-3 sm:mt-5 mb-2 sm:mb-3'>
                        Popular Treatments
                    </BioType>
                </div>
                ...
                <div className='sm:w-[460px] mt-10 flex flex-col space-y-4 items-start'>
                    <BioType className='inter-h5-bold text-black text-[18px] text-center'>
                         Any other questions?
                    </BioType>
                    <BioType className='inter-h5-regular text-black text-[18px] text-start'>
                         Contact the BIOVERSE Care Team at{' '}
                        <a
                    ...
                    <div className='space-y-24 w-full'>
                        <Button
                            variant='outlined'
                            className='w-full normal-case rounded-lg border-[1px] border-black'
                            onClick={() => router.push('/portal/order-history')}
                        >
                            <BioType className='text-black text-[16px] inter-h5-bold'>
