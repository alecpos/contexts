...
export default function WLIntroFirstClientComponentNew({}: GoodToGoProps) {
        ...
        <>
            <div className={`justify-center flex mt-[1.25rem] md:mt-[48px]`}>
                <div className="flex flex-col ">
                    <div className="flex flex-col gap-[1.25rem] md:gap-6 mb-[1.25rem] md:mb-[48px]">
                        ...
                        <WordByWord
                            className={`inter-h5-question-header-bold text-[#6fb1cd]`}
                        >
