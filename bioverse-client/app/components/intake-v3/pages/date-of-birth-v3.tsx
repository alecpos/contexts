...
export default function DateOfBirthSelectionClientComponentV3({
    date_of_birth,
    user_id,
}: StateSelectionProps) {
    ...
    return (
        <>
            <div className={`flex flex-col animate-slideRight mt-1 mt-[1.25rem] md:mt-[48px]`}>
                <p className={`inter-h5-question-header mb-[20px] md:mb-[48px]`}>
