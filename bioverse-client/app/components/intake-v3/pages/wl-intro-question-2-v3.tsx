...
export default function WLIntroQuestion2Component({}: GoodToGoProps) {
    ...
    const [answer, setAnswer] = useSessionStorage('wl-intro-q2', {
                    ...
                    <div className="flex flex-col ">
                        <div className="flex flex-col items-center justify-center p-0 min-w-full">
                            <div className="flex flex-col  rounded-md border min-w-full">
                                ...
                                >
                                    On average, how much sleep do you get a
                                    night?
                                </BioType>
