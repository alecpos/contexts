...
import {} from '../../styles/intake-tailwind-declarations';
import {
    identifyUser,
    triggerEvent,
...
export default function DataCollectionInputV5({
    userProfileData,
    session_id,
    setUserProfileData,
    pushToNext,
            ...
            case PRODUCT_HREF.NAD_NASAL_SPRAY:
                return (
                    <BioType className='it-subtitle md:itd-subtitle'>
                        Next, create an account to get started and we&apos;ll
                        match you with a BIOVERSE provider.
                    </BioType>
                );
            default:
                return <></>;
        ...
        <>
            <div>
                ...
                >
                    ...
                    <div className={`inter_body_small_regular flex flex-row `}>
                        <p className='inter_body_small_regular'>
                            <Checkbox
                                id='optInCheckbox'
                                checked={textOptIn}
                        ...
                        <p className='inter_body_small_regular text-weak mt-2'>
                            Opt-in for SMS notifications for offers and updates
                            from BIOVERSE. <br></br>
                            <br></br>
                            By selecting this box, you agree to receive texts
                            from BIOVERSE to the number you provided that might
                            be considered marking. Agreeing is not required to
                            purchase. Message and data rates may apply. Message
                            frequencies varies. Reply HELP for help. Reply STOP
                            to opt-out. Read Bioverse&apos;s SMS policy{' '}
                            <a
                    ...
                    <div
                        className={`inter_body_small_regular hidden flex-col gap-2 mt-4`}
                    >
                        <label
