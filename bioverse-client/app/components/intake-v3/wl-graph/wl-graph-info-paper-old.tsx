...
export default function WLPaper({
    ...
    useEffect(() => {
        console.log('lbs lost', poundsLost);
    ...
    }, [poundsLost, newWeight]);

    return (
        <>
            <div className='flex flex-col justify-start items-start gap-[.5rem] md:gap-[5px]'>
                <BioType className='intake-v3-subtitle '>
                    Your estimated new weight
                </BioType>
                <BioType className='inter-h5-constant-bold text-[72px] mt-4'>
                    {currWeight} lbs
                </BioType>
                <div className='flex items-center mt-3'>
                    <ArrowDownwardIcon
                        style={{ marginBottom: 1, color: 'black' }}
                    />
                    <BioType className='flex justify-center items-center  !text-[40px] '>
                        <span className='inter-tight-bold text-[40px]'>
                            {currPoundsLost} lbs
                        </span>
                    </BioType>
                </div>
