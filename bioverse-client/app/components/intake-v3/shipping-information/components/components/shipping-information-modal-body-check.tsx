...
export default function ShippingInformationModalBodyCheck({
    ...
    return (
        <div className='w-full '>
            <BioType className={`intake-subtitle text-[#646465]`}>
            ...
            <FormControl sx={{ width: '100%' }}>
                <div className=' mt-4 w-full'>
                    <BioType
                        className={`inter-tight-bold text-sm font-bold text-[#646465] mb-3 mt-1`}
                    >
                        You entered:
                    </BioType>
                    <RadioGroup
                    ...
                    >
                        <FormControlLabel
                            ...
                            label={
                                <>
                                    <BioType
                                        className={`inter-tight text-sm normal-case`}
                                    >
                                        {addressLineOne} {addressLineTwo}
                                    </BioType>
                                    <BioType
                                        className={`inter-tight text-sm !text[#393939]`}
                                    >
                        ...
                        />
                        <div className='w-[100%] h-[1px] bg-[#e4e4e4] mt-4'></div>
                        <BioType
                            className={`inter-tight-bold text-sm font-bold text-[#646465] mb-2 mt-2`}
                        >
                            We suggest:
                        </BioType>
                        <FormControlLabel
