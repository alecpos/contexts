...
import NewOrderSummary from './order-summary-v3/new-order-summary';
import {
    StatusTag,
    StatusTagAction,
    StatusTagNotes,
...
Props) {
    ...
    // const isBundle = variantPriceData.isBundle;
    ...
    const productNameMapping = new Map([
        ['B12 Injection', 'B12 Methylcobalamin Injection'],
        // Add more mappings here as needed
    ]);

    // In your component
    const mappedProductName =
        productNameMapping.get(productInformationData.name) ||
    ...
    const renderTermsAndConditions = (cadency: string) => {
        if (cadency === 'one_time') {
            return (
                <>
                    <BioType
                        className={`inter_body_small_regular pb-2 !text-[#00000099]`}
                    >
                    ...
                    <BioType className='inter_body_small_regular pb-2 !text-[#00000099]'>
            ...
            .then(async function (result) {
                ...
                if (result.setupIntent?.status === 'succeeded') {
                    ...
                    if (order_update_status === 'success') {
                        ...
                        const url = `/intake-complete/confirmation-v3?${query}&orderId=${currentOrderId}`;
                        router.push(url);
                    }
                }
            });
    ...
    const displayPaymentScreen = () => {
        return (
            <div className='flex flex-col'>
                <BioType className={`inter_body_medium_regular mt-2`}>
                ...
                */}
                ...
                <div className='flex mt-2 md:mt-6 flex-col gap-2 justify-end mb-[1.25rem] md:mb-[48px]'>
