...
import WLOrderSummary from './order-summary-v3/wl-order-summary-ab';
...
import WLOrderSummaryAB from './order-summary-v3/wl-order-summary-ab';
...
export default function WLCheckoutV3AB({
    session_id,
    userEmail,
    product_data,
    userProfileData,
            ...
            if (
                ...
                return (
                    <>
                        ...
                        >
                            By clicking &apos;Submit to provider,&apos; you
                            ...
                            charge $
                            {
                                recommendedPrices[selectedPriceIndex]
            ...
            .then(async function (result) {
                ...
                if (result.setupIntent?.status === 'succeeded') {
                    ...
                    const pvc = new ProductVariantController(
                        ...
                        recommendedPrices[selectedPriceIndex]?.variant_index!,
                    ...
                    const order_update_status = await updateOrderAfterCardDown(
                        ...
                        orderData,
                        {
                            ...
                            variant_text:
                                recommendedPrices[selectedPriceIndex]?.variant,
                    ...
                    if (order_update_status === 'success') {
                        ...
                        if (
                            ...
                            router.push(
                                `/intake/prescriptions/${product_href}/pre-id-v3-post-co?${search}&${query.toString()}`
                            );
                        } else {
    ...
    const displayPaymentScreen = () => {
        return (
            <div className='flex flex-col'>
                <BioType
                    className={`intake-v3-18px-20px-bold mt-2 text-[19px] mb-1`}
                >
                    Select Payment Method
                </BioType>
                <BioType className='intake-subtitle text-weak'>
                    You&apos;ll only be charged if prescribed. You won&apos;t be
                    charged if a provider determines that treatment isn&apos;t
                    right for you.
                </BioType>
    ...
    return (
        <>
            <div
                className={`flex justify-center animate-slideRight max-w-[490px]`}
            >
