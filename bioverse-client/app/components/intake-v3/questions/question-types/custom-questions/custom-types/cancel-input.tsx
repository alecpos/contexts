...
const CancelInputQuestion = ({
    ...
    return (
        <div className='flex flex-col items-center w-full gap-[2.5vw] mt-[1.25rem] md:mt-[48px]'>
            <div className='flex flex-col rounded-md border'>
                <BioType className='intake-h5-constant  leading-8 mb-[14px]'>
                    {question.question}
                </BioType>
                <BioType className='intake-subtitle text-weak mb-3'>
