...
export default function WLCapsuleOverviewComponent({
            ...
            >
                ...
                >
                    <div className='h-[200px] aspect-square relative mx-auto'>
                        <Image
                            src='/img/intake/wl/wl-capsule.png'
                            fill
                    ...
                    <p className='intake-v3-18px-20px-bold mt-3'>
                        Bivoerse Weight Loss Capsules
                    </p>
                    ...
                    <p className='intake-v3-form-label text-weak mt-[0.56rem] md:mt-[9px]'>
                        {' '}
                        Our Weight Loss Capsules contain Bupropion HCl,
                        Naltrexone HCl, and Topiramate.{' '}
                    </p>
                    <p className='intake-v3-form-label text-weak mt-[0.56rem] md:mt-[9px]'>
                        {' '}
                        While weight loss not the primary use for the
                        medications on their own, this combination may have
                        appetite-suppressing effects, contributing to weight
                        loss. This combined therapy was FDA-approved for obesity
                        treatment in 2014.
                    </p>
                    ...
                    <p className='intake-v3-form-label text-weak mt-[0.56rem] md:mt-[9px]'>
                        {' '}
                        Self-reported patient results have shown that patients
                        taking Bioverse Weight Loss Capsules experienced a 10
                        pound decrease in weight during the first month.†
                    </p>
                    ...
                    <p className='intake-v3-form-label text-weak mt-[0.56rem] md:mt-[9px]'>
                        Bioverse offers our Weight Loss Capsules for as little
                        as $66/month. Unlike other healthcare providers, we do
                        not require insurance or prior authorization. Your
                        medication would be shipped to your home at no
                        additional cost if prescribed.
                    </p>
                    ...
                    <Button
                        variant='contained'
                        className='md:hidden mt-[2.5rem] md:mt-[48px] w-full normal-case bg-black hover:bg-slate-800 rounded-[12px] intake-v3-disclaimer-text font-bold text-white h-[2.25rem] md:h-[36px]'
                        onClick={handleContinueButton}
                        disabled={isButtonLoading}
                    >
                        {isButtonLoading ? (
