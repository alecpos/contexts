...
export default function WeightWatchersCompetitorComparisonsQuestion({
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full mt-[1.25rem] md:mt-[48px] mb-[2.5rem] md:mb-[0px]">
            <p className={`inter_h5_regular mb-[1rem] md:mb-[16px]`}>Here&apos;s why Weight Watchers Clinic members have switched to Bioverse.</p>
            ...
            <div className="flex flex-row w-full">
                ...
                >
                    <p 
                        className="flex items-center justify-center h-[3.25rem] md:h-[52px] text-center px-[12px]"
                    ...
                    <p 
                        className="flex items-center justify-center inter_body_small text-[#D11E66] px-[12px] h-[3.25rem] md:h-[52px]"
                        style={{
                            borderBottom: `1px solid rgba(0, 6, 38, 0.1)`,
                        }}
                    >
