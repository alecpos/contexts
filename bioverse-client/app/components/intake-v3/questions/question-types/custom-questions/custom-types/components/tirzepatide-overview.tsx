...
export default function TirzepatideOverviewComponent({
            ...
            >
                ...
                >
                    <div className='h-[200px] aspect-square relative mx-auto'>
                        <Image
                            src='/img/intake/wl/tirzepatide/clear-tirzepatide-syringe-cropped.png'
                            fill
                    ...
                    <p className='intake-v3-18px-20px-bold mt-3'>Tirzepatide</p>
                    ...
                    <p className='intake-v3-form-label text-weak mt-[0.56rem] md:mt-[9px]'>
                        {' '}
                        Tirzepatide is the generic name for Mounjaro® and
                        Zepbound™, GLP-1 medications that are FDA-approved for
                        treatment of type 2 diabetes and weight loss
                        respectively.
                    </p>
                    <p className='intake-v3-form-label text-weak mt-[0.56rem] md:mt-[9px]'>
                        {' '}
                        Compounded tirzepatide contains the same active
                    ...
                    <p className='intake-v3-form-label text-weak mt-[0.56rem] md:mt-[9px]'>
                        {' '}
                        Studies have shown that once weekly tirzepatide
                        injections led to 20% of body weight loss on average
                        over 72 weeks.†
                    </p>
                    ...
                    <p className='intake-v3-form-label text-weak mt-[0.56rem] md:mt-[9px]'>
                        {' '}
                        BIOVERSE offers compounded tirzepatide for as little as
                        ${getPrice(PRODUCT_HREF.TIRZEPATIDE)}/month – much more
