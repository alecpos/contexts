...
export default function RoCompetitorComparisonsQuestion({
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full mt-[1.25rem] md:mt-[48px] mb-[2.5rem] md:mb-[0px]">
            <p className={`inter_h5_regular mb-[1rem] md:mb-[16px]`}>Here&apos;s why Ro members have switched to Bioverse.</p>
