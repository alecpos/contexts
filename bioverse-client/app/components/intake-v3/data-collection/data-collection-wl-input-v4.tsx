...
export default function DataCollectionInputWLV4({
    userProfileData,
    session_id,
    setUserProfileData,
    pushToNext,
    ...
    return (
        <>
            <div>
                <div className={`flex flex-col w-full  animate-slideRight `}>
                    <BioType className={`inter-h5-question-header text-strong`}>
                        If treatment is prescribed, who will receive the
                        medication?
                    </BioType>
                    {/* Row 1 - 3 */}
                    <div className="flex flex-col md:flex-col gap-[1rem] md:gap-[16px] mt-[1.25rem] md:mt-[48px]">
                        <FormControl className="flex-1 space">
                            ...
                            <OutlinedInput
                                ...
                                required
                                className="intake-subtitle text-black mt-1"
                                sx={{
                                    height: '48px',
                                    '& .MuiInputBase-input': {
                    ...
                    <div
                        className={` hidden md:flex flex-col gap-1 pb-16 md:pb-0 my-[1.25rem] md:my-[48px] `}
                    >
                        <label
                        ...
                        >
                            <div className="flex flex-row gap-1">
                                <Checkbox
                                    ...
                                    name="optIn"
                                    style={{
                                        marginRight: '5px', // Adds space between the checkbox and the text
                                        paddingLeft: 0,
                                        paddingTop: '0px',
                                        paddingBottom: '0px',
                                        marginTop: '0px',
                            ...
                            <BioType className="intake-v3-disclaimer-text text-weak ml-[49px] ">
                                By selecting this box, you agree to received
                        ...
                        <div className="md:flex md:justify-center mt-[20px] md:mt-[32px] ">
                            <ContinueButtonV3
                    ...
                    <div
                        className={`flex md:hidden flex-col gap-1 pb-16 sm:pb-0 my-[1.25rem] md:my-[48px]`}
                    >
                        <label
                            htmlFor="optInCheckbox"
                            className="body2"
                        ...
                        >
                            <div className="flex flex-row gap-1">
                                ...
                                <div className="flex flex-col">
                                    <BioType className="intake-v3-disclaimer-text text-weak mt-1">
                                        Opt-in for SMS notifications for offers
                                        and updates from BIOVERSE.
                                    </BioType>
                                    <BioType className="intake-v3-disclaimer-text  text-weak mt-1">
                                        By selecting this box, you agree to
                                        received texts from BIOVERSE to the
                                        number you provided that might be
                                        considered marking. Agreeing is not
                                        required to purchase. Message and data
                                        rates may apply. Message frequencies
                                        varies. Reply HELP for help. Reply STOP
                                        to opt-out. Read Bioverse&apos;s SMS
                                        policy{' '}
                                        <a
                                            href="https://www.gobioverse.com/sms-terms-of-service"
                                            target="_blank"
