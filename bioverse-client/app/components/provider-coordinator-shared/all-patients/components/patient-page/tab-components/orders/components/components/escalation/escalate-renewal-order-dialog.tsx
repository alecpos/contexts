...
import { createSupabaseEscalation } from '@/app/utils/database/controller/escalations/escalations-api';
...
interface EscalateDialogProps {
    open: boolean;
    onClose: () => void;
    renewal_order_data: RenewalOrderTabs;
    profile_data: APProfileData;
}

export default function EscalateRenewalOrderDialog({
    open,
    onClose,
    renewal_order_data,
    profile_data,
    ...
    const createEscalation = async () => {
        ...
        const escalation_data: EscalationDataObject = {
            order_id: renewal_order_data.renewal_order_id,
            ...
            assigned_pharmacy: renewal_order_data.assigned_pharmacy,
        };

        const result = await createSupabaseEscalation(escalation_data);
