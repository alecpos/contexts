...
export default function RefundConfirmationDialog({
    ...
    // State to hold the reason for refund
    ...
    return (
        ...
        >
            <DialogTitle id='alert-dialog-title'>Confirm Refund</DialogTitle>
            <DialogContent>
                <div className='flex flex-col gap-2 p-2'>
                    <div>
                        <DialogContentText id='alert-dialog-description'>
                            How much to refund patient?
                        </DialogContentText>
                    </div>
                    ...
                    <div>
                        ...
                        <BioType className='body1'>
                            Amount to Refund: {formattedValue}
                        </BioType>
                        <BioType className='body1'>
                            Total Remaining:{' '}
