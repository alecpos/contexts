...
export default function CoordinatorSearchBar({ handleSearch }: SearchBarProps) {
    ...
    return (
        ...
        >
            <InputBase
                sx={{ ml: 1, flex: 1 }}
                className="body1"
                placeholder="Search patients by name, prescription, or tag"
                inputProps={{
                    'aria-label': 'search patients by name, prescription, or tag',
                }}
                startAdornment={
