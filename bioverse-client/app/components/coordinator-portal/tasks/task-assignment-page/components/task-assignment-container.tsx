...
import TaskActionInfoBar from '@/app/components/provider-portal/tasks/task-action-page/components/task-action-info-bar';
import { getNextCoordinatorTask } from '../../utils/findNextTask';
...
export default function TaskAssignmentComponent({
    ...
    const getNextTask = () => getNextCoordinatorTask(userId);
    ...
    }, [userId, router, nextTaskId, isLoading, isValidating, route]);
