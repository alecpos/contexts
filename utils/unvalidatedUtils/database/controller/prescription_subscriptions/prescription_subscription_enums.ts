...
export enum SubscriptionStatusFlags {
    /* 
    * NO_CHECK_IN_HOLD
    * A patient gets this flag in the RenewalValidationJob if they have not completed a checkin form in the past 3 months.
    ...
    * */
    ...
    /*
    * NO_CHECK_IN_HOLD_CHARGED - NEED TO IMPLEMENT
